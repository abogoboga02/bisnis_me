...
function cloneSampleBusinesses() {
  return JSON.parse(JSON.stringify(sampleBusinesses));
}

function cloneSampleTemplates() {
  return JSON.parse(JSON.stringify(sampleTemplates));
}

module.exports = {
  cloneSampleBusinesses,
  cloneSampleTemplates,
};
